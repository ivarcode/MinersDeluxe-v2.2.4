...
public class WorldGenGrandCrystal2 extends WorldGenerator
{
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        {
            par1World.setBlock(par3, par4, par5, MinersDeluxe.grandCrystal.blockID, 0, 2);

            for (int l = 0; l < 1500; ++l)
            {
                int i1 = par3 + par2Random.nextInt(8) - par2Random.nextInt(8);
                int j1 = par4 - par2Random.nextInt(24);
                ...
                if (par1World.getBlockId(i1, j1, k1) == 0)
                {
                    ...
                    for (int i2 = 0; i2 < 6; ++i2)
                    {
                        ...
                        if (j2 == MinersDeluxe.grandCrystal.blockID)
                        {
                            ++l1;
                        }
                    }
                    ...
                    if (l1 == 1)
                    {
                        par1World.setBlock(i1, j1, k1, MinersDeluxe.grandCrystal.blockID, 0, 2);
                    }
                }
            }
